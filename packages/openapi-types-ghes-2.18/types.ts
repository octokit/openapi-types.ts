...
export interface paths {
  ...
  "/applications/{client_id}/grants/{access_token}": {
     ...
     */
    delete: operations["oauth-authorizations/revoke-grant-for-application"];
  };
  "/applications/{client_id}/tokens/{access_token}": {
    ...
    get: operations["oauth-authorizations/check-authorization"];
    /** OAuth applications can use this API method to reset a valid OAuth token without end user involvement. Applications must save the "token" property in the response, because changes take effect immediately. You must use [Basic Authentication](https://docs.github.com/enterprise-server@2.18/rest/overview/other-authentication-methods#basic-authentication) when accessing it, where the username is the OAuth application `client_id` and the password is its `client_secret`. Invalid tokens will return `404 NOT FOUND`. */
    post: operations["oauth-authorizations/reset-authorization"];
    ...
    delete: operations["oauth-authorizations/revoke-authorization-for-application"];
  };
  "/apps/{app_slug}": {
    /**
  ...
  "/reactions/{reaction_id}": {
    ...
    delete: operations["reactions/delete"];
  };
  "/repos/{owner}/{repo}": {
    /**
  ...
  "/repos/{owner}/{repo}/git/refs/{namespace}": {
     ...
     * ```
     */
    get: operations["git/get-all-refs"];
  };
  ...
  "/repos/{owner}/{repo}/pulls/{pull_number}/comments": {
     ...
     * This endpoint triggers [notifications](https://docs.github.com/en/github/managing-subscriptions-and-notifications-on-github/about-notifications). Creating content too quickly using this endpoint may result in abuse rate limiting. See "[Abuse rate limits](https://docs.github.com/enterprise-server@2.18/rest/overview/resources-in-the-rest-api#abuse-rate-limits)" for details.
     */
    post: operations["pulls/create-review-comment-alternative"];
  };
  ...
  "/teams/{team_id}/discussions": {
    ...
    get: operations["teams/list-discussions"];
    /**
  ...
  "/teams/{team_id}/discussions/{discussion_number}": {
    ...
    get: operations["teams/get-discussion"];
    ...
    delete: operations["teams/delete-discussion"];
    ...
    patch: operations["teams/update-discussion"];
  };
  "/teams/{team_id}/discussions/{discussion_number}/comments": {
    ...
    get: operations["teams/list-discussion-comments"];
    /**
     ...
     * This endpoint triggers [notifications](https://docs.github.com/en/github/managing-subscriptions-and-notifications-on-github/about-notifications). Creating content too quickly using this endpoint may result in abuse rate limiting. See "[Abuse rate limits](https://docs.github.com/enterprise-server@2.18/rest/overview/resources-in-the-rest-api#abuse-rate-limits)" for details.
     */
    post: operations["teams/create-discussion-comment"];
  };
  "/teams/{team_id}/discussions/{discussion_number}/comments/{comment_number}": {
    ...
    get: operations["teams/get-discussion-comment"];
    ...
    delete: operations["teams/delete-discussion-comment"];
    ...
    patch: operations["teams/update-discussion-comment"];
  };
  "/teams/{team_id}/discussions/{discussion_number}/comments/{comment_number}/reactions": {
    ...
    get: operations["reactions/list-for-team-discussion-comment"];
    ...
    post: operations["reactions/create-for-team-discussion-comment"];
  };
  "/teams/{team_id}/discussions/{discussion_number}/reactions": {
    ...
    get: operations["reactions/list-for-team-discussion"];
    ...
    post: operations["reactions/create-for-team-discussion"];
  };
  "/teams/{team_id}/members": {
     ...
     */
    get: operations["teams/list-members"];
  };
  ...
  "/teams/{team_id}/memberships/{username}": {
     ...
     */
    get: operations["teams/get-membership-for-user"];
    /**
     ...
     */
    put: operations["teams/add-or-update-membership-for-user"];
    /** To remove a membership between a user and a team, the authenticated user must have 'admin' permissions to the team or be an owner of the organization that the team is associated with. Removing team membership does not delete the user, it just removes their membership from the team. */
    delete: operations["teams/remove-membership-for-user"];
  };
  "/teams/{team_id}/projects": {
    ...
    get: operations["teams/list-projects"];
  };
  "/teams/{team_id}/projects/{project_id}": {
    ...
    get: operations["teams/check-permissions-for-project"];
    /** Adds an organization project to a team. To add a project to a team or update the team's permission on a project, the authenticated user must have `admin` permissions for the project. The project and team must be part of the same organization. */
    put: operations["teams/add-or-update-project-permissions"];
    /** Removes an organization project from a team. An organization owner or a team maintainer can remove any project from the team. To remove a project from a team as an organization member, the authenticated user must have `read` access to both the team and project, or `admin` access to the team or project. **Note:** This endpoint removes the project from the team, but does not delete it. */
    delete: operations["teams/remove-project"];
  };
  "/teams/{team_id}/repos": {
    /**
...
export interface operations {
   ...
   * Deleting an OAuth application's grant will also delete all OAuth tokens associated with the application for the user. Once deleted, the application will have no access to the user's account and will no longer be listed on [the application authorizations settings screen within GitHub](https://github.com/settings/applications#authorized).
   */
  "oauth-authorizations/revoke-grant-for-application": {
    parameters: {
      path: {
        /** The client ID of your GitHub app. */
  ...
  /** OAuth applications can use a special API method for checking OAuth token validity without running afoul of normal rate limits for failed login attempts. Authentication works differently with this particular endpoint. You must use [Basic Authentication](https://docs.github.com/enterprise-server@2.18/rest/overview/other-authentication-methods#basic-authentication) when accessing it, where the username is the OAuth application `client_id` and the password is its `client_secret`. Invalid tokens will return `404 NOT FOUND`. */
  "oauth-authorizations/check-authorization": {
    parameters: {
      path: {
        /** The client ID of your GitHub app. */
        client_id: components["parameters"]["client-id"];
  ...
  /** OAuth applications can use this API method to reset a valid OAuth token without end user involvement. Applications must save the "token" property in the response, because changes take effect immediately. You must use [Basic Authentication](https://docs.github.com/enterprise-server@2.18/rest/overview/other-authentication-methods#basic-authentication) when accessing it, where the username is the OAuth application `client_id` and the password is its `client_secret`. Invalid tokens will return `404 NOT FOUND`. */
  "oauth-authorizations/reset-authorization": {
    parameters: {
      path: {
        /** The client ID of your GitHub app. */
        client_id: components["parameters"]["client-id"];
  ...
  /** OAuth application owners can revoke a single token for an OAuth application. You must use [Basic Authentication](https://docs.github.com/enterprise-server@2.18/rest/overview/other-authentication-methods#basic-authentication) for this method, where the username is the OAuth application `client_id` and the password is its `client_secret`. */
  "oauth-authorizations/revoke-authorization-for-application": {
    parameters: {
      path: {
        /** The client ID of your GitHub app. */
        client_id: components["parameters"]["client-id"];
      ...
      content: {
        "application/json": (
          ...
          output?: {
            ...
            /** Adds images to the output displayed in the GitHub pull request UI. See the [`images` object](https://docs.github.com/enterprise-server@2.18/rest/reference/checks#images-object) description for details. */
            images?: {
      ...
      content: {
        ...
        > &
          ...
          output?: {
            ...
            /** Adds images to the output displayed in the GitHub pull request UI. See the [`images` object](https://docs.github.com/enterprise-server@2.18/rest/reference/checks#annotations-object-1) description for details. */
            images?: {
              /** The alternative text for the image. */
              alt: string;
              /** The full URL of the image. */
  ...
  "reactions/list-for-commit-comment": {
    parameters: {
      ...
      query: {
        /** Returns a single [reaction type](https://docs.github.com/enterprise-server@2.18/rest/reference/reactions#reaction-types). Omit this parameter to list all reactions to a commit comment. */
        content?:
          | "+1"
          | "-1"
          | "laugh"
  ...
  "reactions/list-for-issue-comment": {
    parameters: {
      ...
      query: {
        /** Returns a single [reaction type](https://docs.github.com/enterprise-server@2.18/rest/reference/reactions#reaction-types). Omit this parameter to list all reactions to an issue comment. */
        content?:
          | "+1"
          | "-1"
          | "laugh"
  ...
  "reactions/list-for-issue": {
    parameters: {
      ...
      query: {
        /** Returns a single [reaction type](https://docs.github.com/enterprise-server@2.18/rest/reference/reactions#reaction-types). Omit this parameter to list all reactions to an issue. */
        content?:
          | "+1"
          | "-1"
          | "laugh"
  ...
  "reactions/list-for-pull-request-review-comment": {
    parameters: {
      ...
      query: {
        /** Returns a single [reaction type](https://docs.github.com/enterprise-server@2.18/rest/reference/reactions#reaction-types). Omit this parameter to list all reactions to a pull request review comment. */
        content?:
          | "+1"
          | "-1"
          | "laugh"
   ...
   * This endpoint triggers [notifications](https://docs.github.com/en/github/managing-subscriptions-and-notifications-on-github/about-notifications). Creating content too quickly using this endpoint may result in abuse rate limiting. See "[Abuse rate limits](https://docs.github.com/enterprise-server@2.18/rest/overview/resources-in-the-rest-api#abuse-rate-limits)" for details.
   */
  "pulls/create-review-comment-alternative": {
    parameters: {
      path: {
        owner: components["parameters"]["owner"];
        repo: components["parameters"]["repo"];
  ...
  "search/code": {
    parameters: {
      query: {
        ...
        q: string;
        /** Sorts the results of your query. Can only be `indexed`, which indicates how recently a file has been indexed by the GitHub Enterprise Server search infrastructure. Default: [best match](https://docs.github.com/enterprise-server@2.18/rest/reference/search#ranking-search-results) */
        sort?: "indexed";
        /** Determines whether the first search result returned is the highest number of matches (`desc`) or lowest number of matches (`asc`). This parameter is ignored unless you provide `sort`. */
  ...
  "search/commits": {
    parameters: {
      query: {
        ...
        q: string;
        /** Sorts the results of your query by `author-date` or `committer-date`. Default: [best match](https://docs.github.com/enterprise-server@2.18/rest/reference/search#ranking-search-results) */
  ...
  "search/labels": {
    parameters: {
      query: {
        ...
        repository_id: number;
        /** The search keywords. This endpoint does not accept qualifiers in the query. To learn more about the format of the query, see [Constructing a search query](https://docs.github.com/enterprise-server@2.18/rest/reference/search#constructing-a-search-query). */
        q: string;
        /** Sorts the results of your query by when the label was `created` or `updated`. Default: [best match](https://docs.github.com/enterprise-server@2.18/rest/reference/search#ranking-search-results) */
        sort?: "created" | "updated";
        /** Determines whether the first search result returned is the highest number of matches (`desc`) or lowest number of matches (`asc`). This parameter is ignored unless you provide `sort`. */
        order?: components["parameters"]["order"];
        /** Results per page (max 100). */
  ...
  "search/repos": {
    parameters: {
      query: {
        ...
        q: string;
        /** Sorts the results of your query by number of `stars`, `forks`, or `help-wanted-issues` or how recently the items were `updated`. Default: [best match](https://docs.github.com/enterprise-server@2.18/rest/reference/search#ranking-search-results) */
  ...
  "search/users": {
    parameters: {
      query: {
        ...
        q: string;
        /** Sorts the results of your query by number of `followers` or `repositories`, or when the person `joined` GitHub Enterprise Server. Default: [best match](https://docs.github.com/enterprise-server@2.18/rest/reference/search#ranking-search-results) */
  ...
  /** List all comments on a team discussion. OAuth access tokens require the `read:discussion` [scope](https://docs.github.com/enterprise-server@2.18/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/). */
  "teams/list-discussion-comments": {
    parameters: {
      header: {
        /** This API is under preview and subject to change. */
        accept: string;
   ...
   * This endpoint triggers [notifications](https://docs.github.com/en/github/managing-subscriptions-and-notifications-on-github/about-notifications). Creating content too quickly using this endpoint may result in abuse rate limiting. See "[Abuse rate limits](https://docs.github.com/enterprise-server@2.18/rest/overview/resources-in-the-rest-api#abuse-rate-limits)" for details.
   */
  "teams/create-discussion-comment": {
    parameters: {
      header: {
        /** This API is under preview and subject to change. */
        accept: string;
  ...
  /** Deletes a comment on a team discussion. OAuth access tokens require the `write:discussion` [scope](https://docs.github.com/enterprise-server@2.18/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/). */
  "teams/delete-discussion-comment": {
    parameters: {
      header: {
        /** This API is under preview and subject to change. */
        accept: string;
  ...
  /** Edits the body text of a discussion comment. OAuth access tokens require the `write:discussion` [scope](https://docs.github.com/enterprise-server@2.18/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/). */
  "teams/update-discussion-comment": {
    parameters: {
      header: {
        /** This API is under preview and subject to change. */
        accept: string;
  ...
  /** List the reactions to a [team discussion comment](https://docs.github.com/enterprise-server@2.18/rest/reference/teams#discussion-comments). OAuth access tokens require the `read:discussion` [scope](https://docs.github.com/enterprise-server@2.18/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/). */
  "reactions/list-for-team-discussion-comment": {
    parameters: {
      header: {
        /** This API is under preview and subject to change. */
        accept: string;
  ...
  /** Create a reaction to a [team discussion comment](https://docs.github.com/enterprise-server@2.18/rest/reference/teams#discussion-comments). OAuth access tokens require the `write:discussion` [scope](https://docs.github.com/enterprise-server@2.18/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/). A response with an HTTP `200` status means that you already added the reaction type to this team discussion comment. */
  "reactions/create-for-team-discussion-comment": {
    parameters: {
      header: {
        /** This API is under preview and subject to change. */
        accept: string;
  ...
  /** List the reactions to a [team discussion](https://docs.github.com/enterprise-server@2.18/rest/reference/teams#discussions). OAuth access tokens require the `read:discussion` [scope](https://docs.github.com/enterprise-server@2.18/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/). */
  "reactions/list-for-team-discussion": {
    parameters: {
      header: {
        /** This API is under preview and subject to change. */
        accept: string;
      ...
      query: {
        /** Returns a single [reaction type](https://docs.github.com/enterprise-server@2.18/rest/reference/reactions#reaction-types). Omit this parameter to list all reactions to a team discussion. */
        content?:
          | "+1"
          | "-1"
          | "laugh"
  ...
  /** Create a reaction to a [team discussion](https://docs.github.com/enterprise-server@2.18/rest/reference/teams#discussions). OAuth access tokens require the `write:discussion` [scope](https://docs.github.com/enterprise-server@2.18/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/). A response with an HTTP `200` status means that you already added the reaction type to this team discussion. */
  "reactions/create-for-team-discussion": {
    parameters: {
      header: {
        /** This API is under preview and subject to change. */
        accept: string;
   ...
   * If the user is already a member of the team, this endpoint will update the role of the team member's role. To update the membership of a team member, the authenticated user must be an organization owner or a team maintainer.
   */
  "teams/add-or-update-membership-for-user": {
    parameters: {
      path: {
        team_id: components["parameters"]["team-id"];
        username: components["parameters"]["username"];
  ...
  /** To remove a membership between a user and a team, the authenticated user must have 'admin' permissions to the team or be an owner of the organization that the team is associated with. Removing team membership does not delete the user, it just removes their membership from the team. */
  "teams/remove-membership-for-user": {
    parameters: {
      path: {
        team_id: components["parameters"]["team-id"];
        username: components["parameters"]["username"];
  ...
  /** Checks whether a team has `read`, `write`, or `admin` permissions for an organization project. If you pass the `hellcat-preview` media type, the response will include projects inherited from a parent team. */
  "teams/check-permissions-for-project": {
    parameters: {
      header: {
        /** This API is under preview and subject to change. */
        accept: string;
  ...
  /** Adds an organization project to a team. To add a project to a team or update the team's permission on a project, the authenticated user must have `admin` permissions for the project. The project and team must be part of the same organization. */
  "teams/add-or-update-project-permissions": {
    parameters: {
      header: {
        /** This API is under preview and subject to change. */
        accept: string;
   ...
   * You can also get information about the specified repository, including what permissions the team grants on it, by passing the following custom [media type](https://docs.github.com/enterprise-server@2.18/rest/overview/media-types/) via the `Accept` header:
   */
  "teams/check-permissions-for-repo": {
    parameters: {
      path: {
        team_id: components["parameters"]["team-id"];
        owner: components["parameters"]["owner"];
   ...
   * Note that, if you choose not to pass any parameters, you'll need to set `Content-Length` to zero when calling out to this endpoint. For more information, see "[HTTP verbs](https://docs.github.com/enterprise-server@2.18/rest/overview/resources-in-the-rest-api#http-verbs)."
   */
  "teams/add-or-update-repo-permissions": {
    parameters: {
      path: {
        team_id: components["parameters"]["team-id"];
        owner: components["parameters"]["owner"];
  ...
  "teams/list-child": {
    ...
    responses: {
      ...
      200: {
        headers: {};
        content: {
          "application/json": components["schemas"]["team-2"][];
        };
      };
    };
  };
