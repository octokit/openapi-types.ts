      ...
      content: {
        "application/json": (
          ...
          output?: {
            ...
            /** Adds images to the output displayed in the GitHub pull request UI. See the [`images` object](https://docs.github.com/enterprise-server@2.19/rest/reference/checks#images-object) description for details. */
            images?: {
